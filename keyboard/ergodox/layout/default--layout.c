...
KB_MATRIX_LAYER(
	...
	1,	KEYPAD_RightParenthesis,	KEYPAD_1_End,	KEYPAD_2_DownArrow,	KEYPAD_3_PageDown,	KEYPAD_Plus,	KEY_ReturnEnter,	
	KEYPAD_0_Insert,	0,	KEYPAD_Period_Delete,	KEY_Equal_Plus,	0,	
	0,	0,	
	0,	0,	0,	
	0,	0,	0	
),
